...
#+begin_src emacs-lisp
  ...
  (require 'mhtml-mode)
  (unbind-key "C-c 8" mhtml-mode-map)
#+end_src
...
Because macOS stores its various configurations inside the developer directory, the standard value of ~man-header-file-path~ is not sufficient.

#+begin_src emacs-lisp
  (require 'woman)
  (add-to-list 'woman-manpath "/Library/Developer/CommandLineTools/SDKs/MacOSX10.15.sdk/usr/share/man")
#+end_src
