...
~svg-tag-mode~ provides very fetching SVG icons for ~TODO~ items and the like.
  ...
  (use-package svg-tag-mode
    ...
    (setq svg-tag-tags
          `(
            ...
            ;; TODO / DONE
            ("TODO" . ((lambda (tag) (svg-tag-make "TODO" :face 'org-todo :padding 2 :scootch 0))))
            ("DONE" . ((lambda (tag) (svg-tag-make "DONE" :face 'org-done :padding 2 :scootch 0))))
